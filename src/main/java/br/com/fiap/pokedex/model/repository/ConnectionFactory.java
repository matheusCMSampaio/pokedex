	...
	public Connection getConexao() {
		try {
			...
			if (this.getDriver() == null || this.getDriver().equals("")) {
				System.out.println("Erro nome na classe");
				throw new RuntimeException("Erro nome na classe");

			}
			if (this.getUser() == null || this.getUser().equals("")) {
				System.out.println("Erro nome de usuario");
				throw new RuntimeException("Erro nome de usuario");
			}
